...
vi.mock('@cypher-asi/zui', () => ({
  Panel: vi.fn().mockImplementation(({ children, className, onPointerDown, style, ...props }: any) =>
    createElement('div', { className, onPointerDown, style, ...props }, children)),
  ButtonWindow: vi.fn().mockImplementation(({ action, onClick }: any) =>
...
describe('WindowContent', () => {
  ...
  it('renders children content', () => {
    ...
    render(
      createElement(WindowContent, { window: win }, 
  ...
  it('starts resize drag on resize handle pointer down', () => {
    ...
    fireEvent.pointerDown(resizeSE!, { clientX: 900, clientY: 700 });
  ...
  it('starts move drag on title bar pointer down', () => {
    ...
    fireEvent.pointerDown(titleBar!, { clientX: 300, clientY: 110 });
  ...
  it('supports ref forwarding', () => {
    ...
    render(
      createElement(WindowContent, { window: win, ref }, 'Content'),
      { wrapper: createTestWrapper(mockDesktop) }
    );
